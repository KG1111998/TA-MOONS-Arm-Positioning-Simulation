...
def run_module2(source_name):
    csv_path = fr"selected_ysos_{source_name}.csv"
    ...
    ysos_df['coord'] = [SkyCoord(ra=ra*u.deg, dec=dec*u.deg) for ra, dec in zip(ysos_df['RA_deg'], ysos_df['DEC_deg'])]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="TA-MOONS Robotic Arm Full Pipeline")
